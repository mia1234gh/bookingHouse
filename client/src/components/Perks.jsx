...
const Perks = ({ selected, onChangeSelected }) => {
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2 mt-2">
      <label className="flex flex-row border p-4 justify-center items-center gap-2 rounded-2xl cursor-pointer text-sm">
        <input
          type="checkbox"
